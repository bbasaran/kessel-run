...
public class _8 {
    ...
    public _8 withLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public _8 withProficiencyBonus(String proficiencyBonus) {
        this.proficiencyBonus = proficiencyBonus;
        return this;
    }
    ...
    public _8 withFeatures(String features) {
        this.features = features;
        return this;
    }
    ...
    public _8 withRages(String rages) {
        this.rages = rages;
        return this;
    }
    ...
    public _8 withRageDamage(String rageDamage) {
        this.rageDamage = rageDamage;
        return this;
    }
    ...
    public _8 withBerserkerInstincts(String berserkerInstincts) {
        this.berserkerInstincts = berserkerInstincts;
        return this;
    }
    ...
    public _8 withForcePowersKnown(String forcePowersKnown) {
        this.forcePowersKnown = forcePowersKnown;
        return this;
    }
    ...
    public _8 withForcePoints(String forcePoints) {
        this.forcePoints = forcePoints;
        return this;
    }
    ...
    public _8 withMaxPowerLevel(String maxPowerLevel) {
        this.maxPowerLevel = maxPowerLevel;
        return this;
    }
    ...
    public _8 withForceEmpoweredCastingOptions(String forceEmpoweredCastingOptions) {
        this.forceEmpoweredCastingOptions = forceEmpoweredCastingOptions;
        return this;
    }
    ...
    public _8 withTechPowersKnown(String techPowersKnown) {
        this.techPowersKnown = techPowersKnown;
        return this;
    }
    ...
    public _8 withTechPoints(String techPoints) {
        this.techPoints = techPoints;
        return this;
    }
    ...
    public _8 withPotentAptitude(String potentAptitude) {
        this.potentAptitude = potentAptitude;
        return this;
    }
    ...
    public _8 withModificationSlots(String modificationSlots) {
        this.modificationSlots = modificationSlots;
        return this;
    }
    ...
    public _8 withManeuversKnown(String maneuversKnown) {
        this.maneuversKnown = maneuversKnown;
        return this;
    }
    ...
    public _8 withSuperiorityDiceQuantity(String superiorityDiceQuantity) {
        this.superiorityDiceQuantity = superiorityDiceQuantity;
        return this;
    }
    ...
    public _8 withSuperiorityDiceSize(String superiorityDiceSize) {
        this.superiorityDiceSize = superiorityDiceSize;
        return this;
    }
    ...
    public _8 withStrategiesKnown(String strategiesKnown) {
        this.strategiesKnown = strategiesKnown;
        return this;
    }
    ...
    public _8 withFocusedStrikes(String focusedStrikes) {
        this.focusedStrikes = focusedStrikes;
        return this;
    }
    ...
    public _8 withAurasKnown(String aurasKnown) {
        this.aurasKnown = aurasKnown;
        return this;
    }
    ...
    public _8 withAuraRadius(String auraRadius) {
        this.auraRadius = auraRadius;
        return this;
    }
    ...
    public _8 withMartialArts(String martialArts) {
        this.martialArts = martialArts;
        return this;
    }
    ...
    public _8 withFocusPoints(String focusPoints) {
        this.focusPoints = focusPoints;
        return this;
    }
    ...
    public _8 withMonasticVows(String monasticVows) {
        this.monasticVows = monasticVows;
        return this;
    }
    ...
    public _8 withUnarmoredMovement(String unarmoredMovement) {
        this.unarmoredMovement = unarmoredMovement;
        return this;
    }
    ...
    public _8 withSneakAttack(String sneakAttack) {
        this.sneakAttack = sneakAttack;
        return this;
    }
    ...
    public _8 withOperativeExploits(String operativeExploits) {
        this.operativeExploits = operativeExploits;
        return this;
    }
    ...
    public _8 withDiscoveries(String discoveries) {
        this.discoveries = discoveries;
        return this;
    }
    ...
    public _8 withRangerSQuarry(String rangerSQuarry) {
        this.rangerSQuarry = rangerSQuarry;
        return this;
    }
    ...
    public _8 withRoutinesKnown(String routinesKnown) {
        this.routinesKnown = routinesKnown;
        return this;
    }
    ...
    public _8 withRoutineRadius(String routineRadius) {
        this.routineRadius = routineRadius;
        return this;
    }
    ...
    public _8 withKineticCombat(String kineticCombat) {
        this.kineticCombat = kineticCombat;
        return this;
    }
    ...
    public _8 withIdealsKnown(String idealsKnown) {
        this.idealsKnown = idealsKnown;
        return this;
    }
    ...
    public _8 withIdealManifests(String idealManifests) {
        this.idealManifests = idealManifests;
        return this;
    }
    ...
    public _8 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
