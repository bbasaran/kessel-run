...
public class _6 {
    ...
    public _6 withLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public _6 withProficiencyBonus(String proficiencyBonus) {
        this.proficiencyBonus = proficiencyBonus;
        return this;
    }
    ...
    public _6 withFeatures(String features) {
        this.features = features;
        return this;
    }
    ...
    public _6 withRages(String rages) {
        this.rages = rages;
        return this;
    }
    ...
    public _6 withRageDamage(String rageDamage) {
        this.rageDamage = rageDamage;
        return this;
    }
    ...
    public _6 withBerserkerInstincts(String berserkerInstincts) {
        this.berserkerInstincts = berserkerInstincts;
        return this;
    }
    ...
    public _6 withForcePowersKnown(String forcePowersKnown) {
        this.forcePowersKnown = forcePowersKnown;
        return this;
    }
    ...
    public _6 withForcePoints(String forcePoints) {
        this.forcePoints = forcePoints;
        return this;
    }
    ...
    public _6 withMaxPowerLevel(String maxPowerLevel) {
        this.maxPowerLevel = maxPowerLevel;
        return this;
    }
    ...
    public _6 withForceEmpoweredCastingOptions(String forceEmpoweredCastingOptions) {
        this.forceEmpoweredCastingOptions = forceEmpoweredCastingOptions;
        return this;
    }
    ...
    public _6 withTechPowersKnown(String techPowersKnown) {
        this.techPowersKnown = techPowersKnown;
        return this;
    }
    ...
    public _6 withTechPoints(String techPoints) {
        this.techPoints = techPoints;
        return this;
    }
    ...
    public _6 withPotentAptitude(String potentAptitude) {
        this.potentAptitude = potentAptitude;
        return this;
    }
    ...
    public _6 withModificationSlots(String modificationSlots) {
        this.modificationSlots = modificationSlots;
        return this;
    }
    ...
    public _6 withManeuversKnown(String maneuversKnown) {
        this.maneuversKnown = maneuversKnown;
        return this;
    }
    ...
    public _6 withSuperiorityDiceQuantity(String superiorityDiceQuantity) {
        this.superiorityDiceQuantity = superiorityDiceQuantity;
        return this;
    }
    ...
    public _6 withSuperiorityDiceSize(String superiorityDiceSize) {
        this.superiorityDiceSize = superiorityDiceSize;
        return this;
    }
    ...
    public _6 withStrategiesKnown(String strategiesKnown) {
        this.strategiesKnown = strategiesKnown;
        return this;
    }
    ...
    public _6 withFocusedStrikes(String focusedStrikes) {
        this.focusedStrikes = focusedStrikes;
        return this;
    }
    ...
    public _6 withAurasKnown(String aurasKnown) {
        this.aurasKnown = aurasKnown;
        return this;
    }
    ...
    public _6 withAuraRadius(String auraRadius) {
        this.auraRadius = auraRadius;
        return this;
    }
    ...
    public _6 withMartialArts(String martialArts) {
        this.martialArts = martialArts;
        return this;
    }
    ...
    public _6 withFocusPoints(String focusPoints) {
        this.focusPoints = focusPoints;
        return this;
    }
    ...
    public _6 withMonasticVows(String monasticVows) {
        this.monasticVows = monasticVows;
        return this;
    }
    ...
    public _6 withUnarmoredMovement(String unarmoredMovement) {
        this.unarmoredMovement = unarmoredMovement;
        return this;
    }
    ...
    public _6 withSneakAttack(String sneakAttack) {
        this.sneakAttack = sneakAttack;
        return this;
    }
    ...
    public _6 withOperativeExploits(String operativeExploits) {
        this.operativeExploits = operativeExploits;
        return this;
    }
    ...
    public _6 withDiscoveries(String discoveries) {
        this.discoveries = discoveries;
        return this;
    }
    ...
    public _6 withRangerSQuarry(String rangerSQuarry) {
        this.rangerSQuarry = rangerSQuarry;
        return this;
    }
    ...
    public _6 withRoutinesKnown(String routinesKnown) {
        this.routinesKnown = routinesKnown;
        return this;
    }
    ...
    public _6 withRoutineRadius(String routineRadius) {
        this.routineRadius = routineRadius;
        return this;
    }
    ...
    public _6 withKineticCombat(String kineticCombat) {
        this.kineticCombat = kineticCombat;
        return this;
    }
    ...
    public _6 withIdealsKnown(String idealsKnown) {
        this.idealsKnown = idealsKnown;
        return this;
    }
    ...
    public _6 withIdealManifests(String idealManifests) {
        this.idealManifests = idealManifests;
        return this;
    }
    ...
    public _6 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
