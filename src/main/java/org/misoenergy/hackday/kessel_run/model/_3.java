...
public class _3 {
    ...
    public _3 withLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public _3 withProficiencyBonus(String proficiencyBonus) {
        this.proficiencyBonus = proficiencyBonus;
        return this;
    }
    ...
    public _3 withFeatures(String features) {
        this.features = features;
        return this;
    }
    ...
    public _3 withRages(String rages) {
        this.rages = rages;
        return this;
    }
    ...
    public _3 withRageDamage(String rageDamage) {
        this.rageDamage = rageDamage;
        return this;
    }
    ...
    public _3 withBerserkerInstincts(String berserkerInstincts) {
        this.berserkerInstincts = berserkerInstincts;
        return this;
    }
    ...
    public _3 withForcePowersKnown(String forcePowersKnown) {
        this.forcePowersKnown = forcePowersKnown;
        return this;
    }
    ...
    public _3 withForcePoints(String forcePoints) {
        this.forcePoints = forcePoints;
        return this;
    }
    ...
    public _3 withMaxPowerLevel(String maxPowerLevel) {
        this.maxPowerLevel = maxPowerLevel;
        return this;
    }
    ...
    public _3 withForceEmpoweredCastingOptions(String forceEmpoweredCastingOptions) {
        this.forceEmpoweredCastingOptions = forceEmpoweredCastingOptions;
        return this;
    }
    ...
    public _3 withTechPowersKnown(String techPowersKnown) {
        this.techPowersKnown = techPowersKnown;
        return this;
    }
    ...
    public _3 withTechPoints(String techPoints) {
        this.techPoints = techPoints;
        return this;
    }
    ...
    public _3 withPotentAptitude(String potentAptitude) {
        this.potentAptitude = potentAptitude;
        return this;
    }
    ...
    public _3 withModificationSlots(String modificationSlots) {
        this.modificationSlots = modificationSlots;
        return this;
    }
    ...
    public _3 withManeuversKnown(String maneuversKnown) {
        this.maneuversKnown = maneuversKnown;
        return this;
    }
    ...
    public _3 withSuperiorityDiceQuantity(String superiorityDiceQuantity) {
        this.superiorityDiceQuantity = superiorityDiceQuantity;
        return this;
    }
    ...
    public _3 withSuperiorityDiceSize(String superiorityDiceSize) {
        this.superiorityDiceSize = superiorityDiceSize;
        return this;
    }
    ...
    public _3 withStrategiesKnown(String strategiesKnown) {
        this.strategiesKnown = strategiesKnown;
        return this;
    }
    ...
    public _3 withFocusedStrikes(String focusedStrikes) {
        this.focusedStrikes = focusedStrikes;
        return this;
    }
    ...
    public _3 withAurasKnown(String aurasKnown) {
        this.aurasKnown = aurasKnown;
        return this;
    }
    ...
    public _3 withAuraRadius(String auraRadius) {
        this.auraRadius = auraRadius;
        return this;
    }
    ...
    public _3 withMartialArts(String martialArts) {
        this.martialArts = martialArts;
        return this;
    }
    ...
    public _3 withFocusPoints(String focusPoints) {
        this.focusPoints = focusPoints;
        return this;
    }
    ...
    public _3 withMonasticVows(String monasticVows) {
        this.monasticVows = monasticVows;
        return this;
    }
    ...
    public _3 withUnarmoredMovement(String unarmoredMovement) {
        this.unarmoredMovement = unarmoredMovement;
        return this;
    }
    ...
    public _3 withSneakAttack(String sneakAttack) {
        this.sneakAttack = sneakAttack;
        return this;
    }
    ...
    public _3 withOperativeExploits(String operativeExploits) {
        this.operativeExploits = operativeExploits;
        return this;
    }
    ...
    public _3 withDiscoveries(String discoveries) {
        this.discoveries = discoveries;
        return this;
    }
    ...
    public _3 withRangerSQuarry(String rangerSQuarry) {
        this.rangerSQuarry = rangerSQuarry;
        return this;
    }
    ...
    public _3 withRoutinesKnown(String routinesKnown) {
        this.routinesKnown = routinesKnown;
        return this;
    }
    ...
    public _3 withRoutineRadius(String routineRadius) {
        this.routineRadius = routineRadius;
        return this;
    }
    ...
    public _3 withKineticCombat(String kineticCombat) {
        this.kineticCombat = kineticCombat;
        return this;
    }
    ...
    public _3 withIdealsKnown(String idealsKnown) {
        this.idealsKnown = idealsKnown;
        return this;
    }
    ...
    public _3 withIdealManifests(String idealManifests) {
        this.idealManifests = idealManifests;
        return this;
    }
    ...
    public _3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
